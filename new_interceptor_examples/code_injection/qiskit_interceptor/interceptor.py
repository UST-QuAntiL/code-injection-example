...
class BaseInterceptor:
    """Class to intercept calls to a quantum circuit execution or quantum annealing sampling function with."""
    ...
    @staticmethod
    def get_interceptor_for_framework(framework: str) -> Type["BaseInterceptor"]:
