...
class DWaveInterceptor():
    ...
    def set_braketdwave_sampler(braketdwave_sampler: Callable):
        ...
        DWaveInterceptor.__braketdwave_sampler = braketdwave_sampler
        DWaveInterceptor._braketdwave_sampler_signature = sampler_signature
    ...
    @staticmethod
    def braket_interceptor(*args, **kwargs):
        ...
        """
        braketdwave_sampler = DWaveInterceptor.__braketdwave_sampler
