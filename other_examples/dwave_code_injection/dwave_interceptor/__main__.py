...
def main(entry_point: str, token: str, backend: str, no_intercept: bool=False, dry_run: bool=False, quiet: bool=False, **kwargs):
    ...
    run(entry_point, token, backend, quiet=quiet, **kwargs)
