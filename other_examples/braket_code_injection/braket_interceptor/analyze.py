...
from .interceptor import BraketDWaveInterceptorInterrupt, BraketDWaveInterceptor

def analyze_execution_results(result: Optional[Any]):
    """Demo analyze method, gets called after user code finished."""
    results = BraketDWaveInterceptor.get_execution_results() # get all results
...
def analyze_interrupted_execution(interrupt: BraketDWaveInterceptorInterrupt):
    """Demo analyze method, gets called when the BraketDWave interceptor interrupted normal execution."""
