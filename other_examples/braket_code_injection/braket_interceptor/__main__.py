...
@c.option("--device_arn", help="The selected quantum backend.")
...
def main(entry_point: str, s3_destination_folder: Tuple[str,str], device_arn:str, no_intercept: bool=False, dry_run: bool=False, quiet: bool=False, **kwargs):
    ...
    run(entry_point, s3_destination_folder, device_arn, quiet=quiet, **kwargs)
